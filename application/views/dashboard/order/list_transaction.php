                                        ...
                                        <td>
                                            <center>
                                                <span data-toggle="modal" data-target="#modalImage">
                                                    <button onClick="seePayment('<?= $row['image_payment'] ?>','<?= $row['order_id'] ?>','<?= base_url() ?>')" class="btn btn-circle bg-danger" data-toggle="tooltip" data-placement="top" title="Lihat Bukti Pembayaran"> <i class="fas fa-money"></i></button>
                                                </span>
                                                <span data-toggle="modal" data-target="#modalInfo">
                                                    <button onClick="infoPemesan('<?= $row['full_name'] ?>','<?= $row['no_hp'] ?>','<?= $row['alamat'] ?>')" class="btn  bg-outline-info" data-toggle="tooltip" data-placement="top" title="Lihat Detail Customer"> <i class="fa fa-info"></i></button>
                                                </span>
                                                <span data-toggle="modal" data-target="#modalPesanan">
                                                    <button onClick="infoPesanan('<?= $row['order_id'] ?>','<?= base_url() ?>')" class="btn bg-navy-dark" data-toggle="tooltip" data-placement="top" title="Lihat Detail Pesanan"> <i class="fa fa-book"></i></button>
                                                </span>
