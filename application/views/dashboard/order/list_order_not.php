                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped dataTable js-exportable max-width100">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($count_pemesanan as $row) { ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= $row['full_name'] ?></td>
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <span data-toggle="modal" data-target="#modalConfirm">
                                                    <button onClick="confirmPesanan('<?= $row['order_id'] ?>','<?= base_url() ?>')" class="btn btn-circle bg-success" data-toggle="tooltip" data-placement="top" title="Konfirmasi Pesanan"> <i class="fa fa-check-circle"></i></button>
                                                </span>
...
<div class="modal fade" id="modalConfirm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>Anda Yakin ingin Mengkonfirmasi pesanan tersebut ?</h5>
            </div>
            <div class="modal-footer bg-navy-dark border-none">
                <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
                <a id="btn_confirm" class="btn bg-color-primary">Konfirmasi Pesanan</a>
            </div>
        </div>
    </div>
</div>
