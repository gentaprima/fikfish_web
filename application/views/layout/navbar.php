...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light bg-color-primary bb-none">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars color-white"></i></a>
      </li>
      <h5 class="mt-2">Dashboard FikFish</h5>
      <!-- <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link color-white">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link color-white">Contact</a>
      </li> -->
    </ul>
